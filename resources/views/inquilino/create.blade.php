            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-7">
                  ...
                  <div class="card card-transparent">
                    <div class="card-body">
                      <form method="POST" sid="form-project" role="form" autocomplete="off" action="/inquilino/save">
                      @csrf
                          ...
                          <div class="row clearfix">
                            <div class="col-md-12">
                              <div class="form-group form-group-default">
                                <label>Codigo</label>
                                <input type="text" class="form-control" name="codigo" maxlength="15" required>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row clearfix">
                            <div class="col-md-6">
                              <div class="form-group form-group-default required">
                                ...
                                <input id="start-date" type="number" class="form-control date" name="telefono" maxlength="15" required>
                              </div>
                            </div>
                            <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group form-group-default required">
                                ...
                                <input type="text" class="form-control" name="observaciones" maxlength="50" required>
                              </div>
                            </div>
                          </div>
                        </div>
