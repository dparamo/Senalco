<template>
    ...
    <div class="">
        <div class="card card-transparent">
            <button class="btn btn-primary" data-target="#modalSlideUp" data-toggle="modal" id="btnFillSizeToggler">Registrar Nuevo Inquilino</button>
        ...
        <div class="card-body">
            ...
            <div class="dataTables_wrapper no-footer" id="condensedTable_wrapper">
                ...
                <tbody>
                    ...
                    <td class="v-align-middle ">
                        <a class="btn btn-success" :href="`/inquilino/factura/${item.id}`">Facturas</a>
                    </td>
                    <td class="v-align-middle ">
...
<div class="modal fade slide-up disable-scroll" id="modalSlideUp2" tabindex="-1" role="dialog" aria-hidden="false">º
    ...
    <div class="modal-content-wrapper">
        ...
        <div class="modal-header clearfix text-left">
            ...
            <h5>Informacion del <span class="semi-bold">Inquilino</span></h5>
...
<script>
    export default {
        ...
        created(){
            ...
            axios.get('/inquilino')
            .then(res=>{
                this.datos = res.data.inquilino.data,
        ...
        methods:{
            ...
            this.dato = {nombre: '', codigo:'',email:'',telefono:'',observaciones:'',estado:''}
            axios.post('/inquilino', datoNueva)
                .then((res) =>{
            ...
            eliminar(item ,index){
                ...
                if (confirmacion) {
                    axios.delete(`/inquilino/${item.id}`)
                    .then(()=>{
                        this.datos.splice(index,1);
                    })
                    .catch(function (error) {
                        alert('el usuario no se puede eliminar: revisar Contratos');
                    });
                }
            },
            info(item){
            ...
            editar(dato){
                ...
                axios.put(`/inquilino/${dato.id}`, params)
                    .then(res=>{
                        axios.get('/inquilino')
                        .then(res=>{
                            this.datos = res.data.inquilino.data
            ...
            buscar(){
                axios.get(`/inquilinos?nombre=${this.busqueda}`)
                        .then(res=>{
                            this.datos = res.data;
                })
            },
             getInquilino: function(page){

               axios.get('inquilino?page='+page)
                .then(res=>{
                this.datos = res.data.inquilino.data,
                this.pagination = res.data.paginate
            })
