            ...
            <div class="dataTables_wrapper no-footer" id="condensedTable_wrapper">
                ...
                <tbody>
                   ...
                   <tbody>
                    ...
                    <td class="v-align-middle ">
                        <button class="btn btn-success" data-target="#modalSlideUp3" data-toggle="modal" id="btnToggleSlideUpSize" @click="datafactura(item)" >PDF</button>
                    </td>
                    </tr>
                </tbody> 
                </table>
...
<!-- Modal pdf -->
<div class="modal fade slide-up disable-scroll" id="modalSlideUp3" tabindex="-1" role="dialog" aria-hidden="false">
    <div class="modal-dialog ">
        <div class="modal-content-wrapper">            
            <div class="modal-content">
                <form id="FormularioPrint">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="pg-close fs-14"></i></button>
                        <div class="row">
                            <div class="col-sm-12">
                                <h2 id="facid">Factura : <span id="FacId"></span></h2>
                            </div>
                        </div>
                    </div>                    
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <p class="p-b-10">MES DE FACTURACION : <span class="semi-bold" id="FacPer"></span></p>
                            </div>
                        </div>                                    
                        <div class="row">
                            <div class="col-sm-16">
                                <p class="p-b-10">NOMBRES: <strong id="FacNom"></strong></p>
                            </div>
                            <div class="col-sm-16">
                                <p class="p-b-10">DIRECCION: <strong id="FacDir"></strong></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-16">
                                <p class="p-b-10">E-MAIL: <strong id="FacEmail"></strong></p>
                            </div>
                            <div class="col-sm-16">
                                <p class="p-b-10">TELEFONO: <strong id="FacTel"></strong></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-condensed">
                                    <thead>
                                        <tr>
                                            <th class="">CANON</th>
                                            <th class="">AVALADORA</th>
                                            <th class="">MULTAS</th>
                                            <th class="">OTROS</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr id="bodyFactura"></tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="p-t-20 clearfix p-l-10 p-r-10">
                                    ...
                                    <div class="pull-right">
                                        <p class="bold font-montserrat text-uppercase" id="TotalFac"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 m-t-10 sm-m-t-10">
                                <button type="button" class="btn btn-primary btn-block m-t-5" onclick="printJS('FormularioPrint','html')">Descargar</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    export default {        
        ...
        methods:{
            ...
            datafactura: function(info){
                var tempContrato = this.contrato.find(ele => ele.id == info.id_contrato);
                var fila = '<td>'+tempContrato.valorcanon+'</td>';
                var tempinquilino = this.inquilino.find(ele => ele.id == info.id_inquilino);
                var tempInmueble = this.inmueble.find(ele => ele.id == info.id_inmueble);
                fila += '<td>'+info.avaladora+'</td>';
                fila += '<td>'+info.multas+'</td>';
                fila += '<td>'+info.otros+'</td>';                
                var total = parseInt(info.avaladora) + parseInt(info.multas)+ parseInt(info.otros);
                document.getElementById('TotalFac').innerText = '$' + total.toString();                
                document.getElementById('bodyFactura').innerHTML = fila;
                document.getElementById('FacId').innerText = info.id;
                document.getElementById('FacNom').innerText = tempinquilino.nombre;
                document.getElementById('FacPer').innerText = info.periodo;
                document.getElementById('FacEmail').innerText = tempinquilino.email;
                document.getElementById('FacTel').innerText = tempinquilino.telefono;
                document.getElementById('FacDir').innerText = tempInmueble.direccion;
